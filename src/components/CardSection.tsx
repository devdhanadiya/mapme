...
export default function CardSection() {
    const { todos, addTodo, editTodo, getTodos, completeTodo, deleteTodo, loading, error, isFetched } = useTodo();
    ...
    const handleAddTodo = useCallback(async (data: CardDataProp) => {
        addTodo({
            ...data,
    ...
    const handleEditTodo = useCallback(async (id: string, todo: CardDataProp) => {
        await editTodo(id, {
            title: todo.title,
    ...
    const handleCompleteTodo = useCallback((id: string, status: boolean) => {
