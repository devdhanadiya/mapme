...
function ToastMessage({ type, message, t }: IToast) {
...
export const Toast = {
  success: (message: string) =>
    toast.custom((t) => <ToastMessage type="success" message={message} t={t} />, time),
  error: (message: string) =>
    toast.custom((t) => <ToastMessage type="error" message={message} t={t} />, time),
  warning: (message: string) =>
    toast.custom((t) => <ToastMessage type="warning" message={message} t={t} />, time),
};
