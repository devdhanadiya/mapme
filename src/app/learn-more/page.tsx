            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  A sleek and efficient task management application designed to help users stay
      ...
      <section className="container mx-auto px-4 py-16 md:px-6">
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3 lg:gap-8 mt-12">
          ...
          <Card className="bg-card text-card-foreground">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Secure login with Google OAuth ensures your data stays protected.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-card text-card-foreground">
          ...
          <Card className="bg-card text-card-foreground">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Plan your tasks with deadlines and priorities to stay on track.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="frontend" className="mt-6 space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Provides server-side rendering, static site generation, and API routes for a
                    complete solution.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Provides beautifully designed, accessible components that integrate with
                    Tailwind CSS.
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="mx-auto max-w-2xl mt-12">
          <Card className="overflow-hidden">
            ...
            <CardContent className="space-y-4">
              <p>
                Dev Dhanadiya is a passionate developer focused on creating intuitive and efficient
                web applications. With expertise in modern JavaScript frameworks and a keen eye for
                design, Dev created MapMe to help users organize their tasks and boost productivity.
              </p>
      ...
      <section className="container mx-auto px-4 py-16 md:px-6">
        ...
        <div className="mx-auto max-w-3xl mt-12">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                MapMe can be deployed on platforms like Vercel. Ensure environment variables are
                configured correctly before deploying.
              </p>
