...
export const createTodoSchema = z.object({
  ...
  description: z
    ...
    .max(400, "Description cannot exceed 400 words"),
  dueTime: z
    .string({ required_error: "Due time is required" })
...
export const updateTodoSchema = createTodoSchema.partial().extend({
  ...
  status: z
    .boolean({ required_error: "status required", invalid_type_error: "Invalid status format" })
    .optional(),
});
